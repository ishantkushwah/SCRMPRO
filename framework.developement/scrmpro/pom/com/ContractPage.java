...
public class ContractPage extends QuotePage{
	...
	public static WebElement Sel_active_on;
...
//	@FindBy(id="ContentPlaceHolder1_AddCont_chkDefaultAdr")
	...
	@FindBy(xpath=".//*[@id='m1']/tbody/tr[2]/td[12]")
	public static WebElement clk_add_productToLineItem_icon;
	
//	@FindBy(xpath="//a[contains(@class,'IsDelete')]")       //modified by Shalini
//	public static WebElement click_delete_milestone_btn;
		
	@FindBy(id="btnInvoice1")
	public static WebElement click_invoice_btn;
...
//	@FindBy(id="chbx_m1p0")
	...
	public static WebElement enter_ordered_quantity;
	...
	public static WebElement clk_add_new_milestone_btn;
...
//	@FindBy(id=".//*[@id='ContentPlaceHolder1_Viewcontract1_lvContract_tdContractNumber_0']")
//	public static WebElement view_Contract;
	
//	@FindBy(id="ContentPlaceHolder1_AddCont_btnEdit")
//	public static WebElement clk_edit_contract_btn;
...
//	@FindBy(id="ContentPlaceHolder1_Viewcontract1_lvContract_cbCheckBox_0")
//	public static WebElement clk_contract_check_box;
	
	@FindBy(id ="lnkShareRecord")
	public static WebElement sel_share_record;
	
//	@FindBy(id="ddlUserList']/optgroup[1]/option[1]")
//	public static WebElement clk_reporting_user;
